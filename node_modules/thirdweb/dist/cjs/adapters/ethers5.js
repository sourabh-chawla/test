...
exports.toEthersContract = toEthersContract;
exports.fromEthersContract = fromEthersContract;
exports.fromEthersSigner = fromEthersSigner;
...
async function fromEthersContract(options) {
    return (0, contract_js_1.getContract)({
        ...
        address: options.ethersContract.address ||
...
async function fromEthersSigner(signer) {
    ...
    const account = {
        ...
        signTypedData: async (data) => {
            return (await signer._signTypedData(data.domain, data.types, 
...
async function toEthersSigner(ethers, client, account, chain) {
    class ThirdwebAdapterSigner extends ethers.Signer {
        ...
        constructor() {
            super();
            ethers.utils.defineReadOnly(this, "provider", toEthersProvider(ethers, client, chain));
        }
        /**
         * @internal
         */
        ...
        async signTransaction(transaction) {
            ...
            const alignedTx = await alignTxFromEthers(client, chain, awaitedTx, ethers);
            const serialized = await (0, to_serializable_transaction_js_1.toSerializableTransaction)({
        ...
        value) {
            ...
            const typedData = {
                ...
                domain: {
                    ...
                    salt: domain.salt ? (0, hex_js_1.toHex)(domain.salt.toString()) : undefined,
...
async function alignTxFromEthers(client, chain, tx, ethers) {
