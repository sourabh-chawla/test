...
exports.isGetBatchesToRevealSupported = isGetBatchesToRevealSupported;
const utils_1 = require("viem/utils");
const fetchTokenMetadata_js_1 = require("../../../../utils/nft/fetchTokenMetadata.js");
const GetBaseURICount = require("../../__generated__/IBatchMintMetadata/read/getBaseURICount.js");
const GetBatchIdAtIndex = require("../../__generated__/IBatchMintMetadata/read/getBatchIdAtIndex.js");
const EncryptedData = require("../../__generated__/IDelayedReveal/read/encryptedData.js");
const BaseURIIndicies = require("../../__generated__/IDrop/read/baseURIIndices.js");
const TokenURI = require("../../__generated__/IERC721A/read/tokenURI.js");
/**
...
async function getBatchesToReveal(options) {
    ...
    const encryptedUriData = await Promise.all(Array.from([...uriIndices]).map((i) => EncryptedData.encryptedData({
        contract: options.contract,
        index: BigInt(i),
    })));
