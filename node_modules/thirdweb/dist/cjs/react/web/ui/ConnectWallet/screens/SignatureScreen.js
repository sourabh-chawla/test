...
const SignatureScreen = (props) => {
    ...
    if (wallet.id === "inApp" ||
        ...
        return ((0, jsx_runtime_1.jsx)(HeadlessSignIn, { error: error, signIn: signIn, status: status, connectLocale: connectLocale, wallet: wallet }));
    }
    const handleRetry = () => {
        signIn();
    };
    return ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { animate: "fadein", fullHeight: true, flex: "column", children: [(0, jsx_runtime_1.jsx)(basic_js_1.Container, { p: "lg", style: {
                ...
                }, flex: "column", px: modalSize === "compact" ? "lg" : "xxl", center: "y", expand: true, children: status === "idle" ? ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(basic_js_1.Container, { flex: "row", center: "x", animate: "fadein", py: "3xl", children: (0, jsx_runtime_1.jsx)(PulsatingContainer, { children: (0, jsx_runtime_1.jsx)(WalletImage_js_1.WalletImage, { id: wallet.id, client: props.client, size: "80" }) }) }), (0, jsx_runtime_1.jsx)(text_js_1.Text, { center: true, multiline: true, balance: true, children: locale.instructionScreen.instruction }), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "lg" }), (0, jsx_runtime_1.jsx)(buttons_js_1.Button, { fullWidth: true, variant: "accent", "data-testid": "sign-in-button", onClick: signIn, style: {
                                alignItems: "center",
                                padding: index_js_1.spacing.md,
                            }, children: connectLocale.signatureScreen.instructionScreen.signInButton }), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "sm" }), (0, jsx_runtime_1.jsx)(buttons_js_1.Button, { fullWidth: true, variant: "secondary", "data-testid": "disconnect-button", onClick: () => {
                                disconnect(wallet);
                            }, style: {
                                alignItems: "center",
                                padding: index_js_1.spacing.md,
...
function HeadlessSignIn({ signIn, error, status, connectLocale, wallet, }) {
    ...
    return ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { p: "lg", fullHeight: true, flex: "column", animate: "fadein", children: [(0, jsx_runtime_1.jsx)(basic_js_1.ModalHeader, { title: locale.signingScreen.title }), (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { expand: true, flex: "row", center: "both", style: {
                    minHeight: "250px",
                }, children: [status === "signing" && (0, jsx_runtime_1.jsx)(Spinner_js_1.Spinner, { size: "xl", color: "accentText" }), status === "failed" && ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { children: [(0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "lg" }), (0, jsx_runtime_1.jsx)(text_js_1.Text, { size: "lg", center: true, color: "danger", children: error || locale.signingScreen.failedToSignIn }), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "lg" }), (0, jsx_runtime_1.jsxs)(buttons_js_1.Button, { fullWidth: true, variant: "accent", onClick: () => {
                                    signIn();
                                }, style: {
                                    gap: index_js_1.spacing.xs,
                                    alignItems: "center",
                                    ...
                                    disconnect(wallet);
                                }, "data-testid": "disconnect-button", style: {
                                    alignItems: "center",
                                    padding: index_js_1.spacing.md,
