...
function detailsBtn_formatFiatBalanceForButton(props) {
    return ` (${(0, balance_js_1.formatAccountFiatBalance)({ ...props, decimals: 0 })})`;
}
/**
 * @internal Exported for test
 */
function detailsBtn_formatTokenBalanceForButton(props) {
    return `${(0, balance_js_1.formatAccountTokenBalance)({ ...props, decimals: props.balance < 1 ? 5 : 4 })}`;
}
/**
...
function DetailsModal(props) {
    ...
    const networkSwitcherButton = ((0, jsx_runtime_1.jsxs)(MenuButton_js_1.MenuButton, { type: "button", disabled: disableSwitchChain, onClick: () => {
            setScreen("network-switcher");
                    ...
                    alignItems: "center",
                    position: "relative",
                }, children: !chainIconQuery.isLoading ? ((0, jsx_runtime_1.jsx)(ChainIcon_js_1.ChainIcon, { chainIconUrl: chainIconQuery.url, size: index_js_1.iconSize.md, active: true, client: client })) : ((0, jsx_runtime_1.jsx)(Skeleton_js_1.Skeleton, { height: `${index_js_1.iconSize.md}px`, width: `${index_js_1.iconSize.md}px` })) }), chainNameQuery.isLoading ? ((0, jsx_runtime_1.jsx)(Skeleton_js_1.Skeleton, { height: "16px", width: "150px" })) : ((0, jsx_runtime_1.jsxs)(text_js_1.Text, { color: "primaryText", size: "md", multiline: true, children: [chainNameQuery.name || `Unknown chain #${walletChain?.id}`, (0, jsx_runtime_1.jsx)(text_js_1.Text, { color: "secondaryText", size: "xs", children: props.showBalanceInFiat ? ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(balance_js_1.AccountBalance, { fallbackComponent: (0, jsx_runtime_1.jsx)(Skeleton_js_1.Skeleton, { height: "1em", width: "70px" }), loadingComponent: (0, jsx_runtime_1.jsx)(Skeleton_js_1.Skeleton, { height: "1em", width: "70px" }), chain: walletChain, tokenAddress: props.displayBalanceToken?.[Number(walletChain?.id)], formatFn: (props) => (0, balance_js_1.formatAccountTokenBalance)({ ...props, decimals: 7 }) }), " ", (0, jsx_runtime_1.jsx)(balance_js_1.AccountBalance, { loadingComponent: (0, jsx_runtime_1.jsx)(Skeleton_js_1.Skeleton, { height: "1em", width: "30px" }), chain: walletChain, tokenAddress: props.displayBalanceToken?.[Number(walletChain?.id)], formatFn: (props) => ` (${(0, balance_js_1.formatAccountFiatBalance)({ ...props, decimals: 3 })})`, showBalanceInFiat: "USD" })] })) : ((0, jsx_runtime_1.jsx)(balance_js_1.AccountBalance, { fallbackComponent: (0, jsx_runtime_1.jsx)(Skeleton_js_1.Skeleton, { height: "1em", width: "100px" }), loadingComponent: (0, jsx_runtime_1.jsx)(Skeleton_js_1.Skeleton, { height: "1em", width: "100px" }), formatFn: (props) => (0, balance_js_1.formatAccountTokenBalance)({ ...props, decimals: 7 }), chain: walletChain, tokenAddress: props.displayBalanceToken?.[Number(walletChain?.id)] })) })] })), (0, jsx_runtime_1.jsx)(StyledChevronRightIcon, { width: index_js_1.iconSize.sm, height: index_js_1.iconSize.sm, style: {
                    flexShrink: 0,
                    marginLeft: "auto",
                } })] }));
