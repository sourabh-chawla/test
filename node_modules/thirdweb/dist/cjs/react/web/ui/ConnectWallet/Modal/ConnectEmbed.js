...
function ConnectEmbed(props) {
    ...
    const autoConnectComp = props.autoConnect !== false && ((0, jsx_runtime_1.jsx)(AutoConnect_js_1.AutoConnect, { chain: preferredChain, appMetadata: props.appMetadata, client: props.client, wallets: wallets, accountAbstraction: props.accountAbstraction, timeout: typeof props.autoConnect === "boolean"
            ? undefined
    ...
    if (isAutoConnecting) {
        ...
        content = ((0, jsx_runtime_1.jsx)(ConnectModalContent_js_1.ConnectModalContent, { shouldSetActive: true, screenSetup: screenSetup, isOpen: true, onClose: () => {
                ...
                titleIconUrl: typeof props.header === "object"
                    ...
                    : undefined,
            }, size: props.size, welcomeScreen: props.welcomeScreen, hideHeader: !props.header, onConnect: props.onConnect, recommendedWallets: props.recommendedWallets, showAllWallets: props.showAllWallets, walletConnect: props.walletConnect, wallets: props.wallets, modalHeader: undefined, walletIdsToHide: undefined }));
    }
