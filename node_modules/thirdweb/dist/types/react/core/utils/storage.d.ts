...
export declare function getLastAuthProvider(storage: AsyncStorage): Promise<import("../../../wallets/types.js").OAuthOption | "email" | "phone" | "passkey" | "wallet" | "jwt" | "auth_endpoint" | "iframe_email_verification" | "iframe" | null>;
