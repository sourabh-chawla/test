import { type SignableMessage, type Signature } from "viem";
 ...
 * @auth
 */
export declare function verifyContractWalletSignature({ signature, message, address, chain, client, accountFactory, }: VerifyContractWalletSignatureParams): Promise<boolean>;
