...
export type { WalletUser, InAppWalletAuth, 
/**
 ...
 */
InAppWalletSocialAuth as EmbeddedWalletSocialAuth, InAppWalletCreationOptions, } from "../wallets/in-app/core/wallet/types.js";
export type { MultiStepAuthArgsType, SingleStepAuthArgsType, } from "../wallets/in-app/core/authentication/types.js";
export { preAuthenticate, authenticate, authenticateWithRedirect, getUserEmail, getUserPhoneNumber, getProfiles, linkProfile, unlinkProfile, } from "../wallets/in-app/web/lib/auth/index.js";
export type { Profile } from "../wallets/in-app/core/authentication/types.js";
export { getUser, type GetUserResult, } from "../wallets/in-app/core/users/getUser.js";
export type { CoinbaseWalletCreationOptions, CoinbaseSDKWalletConnectionOptions, } from "../wallets/coinbase/coinbase-web.js";
