 ...
 * @internal
 */
export declare function connectSmartWallet(wallet: Wallet<"smart">, connectionOptions: SmartWalletConnectionOptions, creationOptions: SmartWalletOptions): Promise<[Account, Chain]>;
/**
 * @internal
 */
