...
import { deployCreate2Factory, getDeployedCreate2Factory, } from "./create-2-factory.js";
import { getDeployedInfraContract, getDeployedInfraContractFromMetadata, prepareInfraContractDeployTransactionFromMetadata, } from "./infra.js";
/**
 ...
 * @contract
 */
export async function getOrDeployInfraForPublishedContract(args) {
 ...
 */
export async function deployCloneFactory(options) {
    // create2 factory
 ...
 */
export async function deployImplementation(options) {
    return getOrDeployInfraContract({
        ...options,
 ...
 * @internal
 */
export async function getOrDeployInfraContract(options) {
...
export async function getOrDeployInfraContractFromMetadata(options) {
    const infraContract = await getDeployedInfraContractFromMetadata(options);
    if (infraContract) {
        return infraContract;
    }
    const transaction = prepareInfraContractDeployTransactionFromMetadata(options);
    await sendAndConfirmTransaction({
        transaction,
        account: options.account,
    });
    const deployedInfraContract = await getDeployedInfraContractFromMetadata(options);
