 ...
 * @beta
 */
export function erc7579(options) {
    ...
    const modularAccountOptions = {
        ...
        overrides: {
                ...
                return execute({
                    ...
                    async asyncParams() {
                        return {
                            ...
                            executionCalldata: AbiParameters.encodePacked(["address", "uint256", "bytes"], [
            ...
            async getAccountNonce(accountContract) {
                ...
                const withValidator = Hex.from(`${defaultValidator}${Hex.fromNumber(entryPointNonce).slice(42)}`);
