...
export async function deployAndSignMessage({ accountContract, factoryContract, options, message, }) {
...
export async function deployAndSignTypedData({ accountContract, factoryContract, options, typedData, }) {
