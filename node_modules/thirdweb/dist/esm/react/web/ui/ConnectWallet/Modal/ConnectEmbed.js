...
export function ConnectEmbed(props) {
    ...
    const autoConnectComp = props.autoConnect !== false && (_jsx(AutoConnect, { chain: preferredChain, appMetadata: props.appMetadata, client: props.client, wallets: wallets, accountAbstraction: props.accountAbstraction, timeout: typeof props.autoConnect === "boolean"
            ? undefined
