...
function ConnectButtonInner(props) {
    ...
    return (_jsx(AccountProvider, { address: activeAccount.address, client: props.client, children: _jsx(ConnectedWalletDetails, { theme: theme, detailsButton: props.detailsButton, detailsModal: props.detailsModal, supportedTokens: supportedTokens, supportedNFTs: props.supportedNFTs, onDisconnect: (info) => {
