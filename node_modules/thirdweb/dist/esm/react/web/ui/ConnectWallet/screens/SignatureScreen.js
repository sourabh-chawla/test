...
export const SignatureScreen = (props) => {
    ...
    if (wallet.id === "inApp" ||
        ...
        return (_jsx(HeadlessSignIn, { error: error, signIn: signIn, status: status, connectLocale: connectLocale, wallet: wallet }));
    }
    const handleRetry = () => {
        signIn();
    };
    return (_jsxs(Container, { animate: "fadein", fullHeight: true, flex: "column", children: [_jsx(Container, { p: "lg", style: {
                ...
                }, flex: "column", px: modalSize === "compact" ? "lg" : "xxl", center: "y", expand: true, children: status === "idle" ? (_jsxs(_Fragment, { children: [_jsx(Container, { flex: "row", center: "x", animate: "fadein", py: "3xl", children: _jsx(PulsatingContainer, { children: _jsx(WalletImage, { id: wallet.id, client: props.client, size: "80" }) }) }), _jsx(Text, { center: true, multiline: true, balance: true, children: locale.instructionScreen.instruction }), _jsx(Spacer, { y: "lg" }), _jsx(Button, { fullWidth: true, variant: "accent", "data-testid": "sign-in-button", onClick: signIn, style: {
                                alignItems: "center",
                                padding: spacing.md,
                            }, children: connectLocale.signatureScreen.instructionScreen.signInButton }), _jsx(Spacer, { y: "sm" }), _jsx(Button, { fullWidth: true, variant: "secondary", "data-testid": "disconnect-button", onClick: () => {
                                disconnect(wallet);
                            }, style: {
                                alignItems: "center",
                                padding: spacing.md,
...
function HeadlessSignIn({ signIn, error, status, connectLocale, wallet, }) {
    ...
    return (_jsxs(Container, { p: "lg", fullHeight: true, flex: "column", animate: "fadein", children: [_jsx(ModalHeader, { title: locale.signingScreen.title }), _jsxs(Container, { expand: true, flex: "row", center: "both", style: {
                    minHeight: "250px",
                }, children: [status === "signing" && _jsx(Spinner, { size: "xl", color: "accentText" }), status === "failed" && (_jsxs(Container, { children: [_jsx(Spacer, { y: "lg" }), _jsx(Text, { size: "lg", center: true, color: "danger", children: error || locale.signingScreen.failedToSignIn }), _jsx(Spacer, { y: "lg" }), _jsxs(Button, { fullWidth: true, variant: "accent", onClick: () => {
                                    signIn();
                                }, style: {
                                    gap: spacing.xs,
                                    alignItems: "center",
