...
export function PayEmbed(props) {
    ...
    if (!localeQuery.data) {
        ...
        content = (_jsxs(_Fragment, { children: [screen === "buy" && (_jsx(BuyScreen, { title: metadata?.name || "Buy", isEmbed: true, supportedTokens: props.supportedTokens, theme: theme, client: props.client, connectLocale: localeQuery.data, hiddenWallets: props.hiddenWallets, payOptions: props.payOptions || {
                        mode: "fund_wallet",
                    }, onDone: () => {
