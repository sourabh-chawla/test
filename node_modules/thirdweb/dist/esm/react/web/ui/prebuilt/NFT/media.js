 ...
 * @beta
 */
export function NFTMedia({ loadingComponent, fallbackComponent, queryOptions, mediaResolver, ...mediaRendererProps }) {
    ...
    return (_jsx(MediaRenderer, { client: contract.client, src: mediaQuery.data.src, poster: mediaQuery.data.poster, ...mediaRendererProps }));
}
/**
