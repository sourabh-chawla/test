 ...
 * @beta
 */
export function NFTDescription({ loadingComponent, fallbackComponent, queryOptions, descriptionResolver, ...restProps }) {
    ...
    return _jsx("span", { ...restProps, children: descQuery.data });
}
/**
